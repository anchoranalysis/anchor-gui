...
public abstract class FileCreatorFromInputManager<T extends InputFromManager> extends FileCreatorGeneralList {
    ...
    protected void addFilesToList(
        ...
        try {
            ...
            List<? extends T> list = input.inputObjects(
    ...
    protected abstract InteractiveFile create(T providesStackInput, MarkCreatorParams markCreatorParams);
